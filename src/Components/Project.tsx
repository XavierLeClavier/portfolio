...
import { SiJavascript, SiTypescript, SiFastapi, SiJupyter, SiPhpmyadmin, SiTailwindcss } from "react-icons/si";
...
const techIcons: { [key: string]: JSX.Element } = {
    ...
    JavaScript: <SiJavascript className="text-yellow-500 w-6 h-6" />,
    NodeJS: <FaNodeJs className="text-green-500 w-6 h-6" />,
    FastAPI: <SiFastapi className="text-green-500 w-6 h-6" />,
    Firebase: <IoLogoFirebase className="text-yellow-500 w-6 h-6" />,
    Python: <FaPython className="text-yellow-500 w-6 h-6" />,
    CSS: <FaCss3Alt className="text-blue-500 w-6 h-6" />,
    Jupyter: <SiJupyter className="text-blue-500 w-6 h-6" />,
    PHP: <FaPhp className="text-blue-500 w-6 h-6" />,
...
export default function Project({ name, url, image, github, description, technologies, keywords }: ProjectProps) {
    return (
